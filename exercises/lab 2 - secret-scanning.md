...
#### Task 1: Enabling secret scanning
...
#### Task 2: Viewing and managing results
...
#### Task 3: Introducing a test secret
...
#### Task 4: Excluding files from secret scanning
...
#### Task 5: Custom patterns for secret scanning (Only Enterprises)
...
#### Task 6: Managing access to alerts (Only Enterprises)
